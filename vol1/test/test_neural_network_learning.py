...
class TestNeuralNetworkLearning(unittest.TestCase):
    def setUp(self) -> None:
        self.nwl: NeuralNetworkLearning      = NeuralNetworkLearning()
    ...
    # y = 0.01 * x ** 2 + 0.1 * x
    def function_1(self, x: float) -> float:
    ...
    # f(x0, x1) = x0 ** 2 + x1 ** 2
    def function_2(self, x: Any) -> Any:
        return np.sum(x ** 2)

    def test_numerical_diff_2(self) -> None:
    ...
    def function_3(self, x0: float) -> float:
        return x0 * x0 + 4.0 ** 2.0

    def test_numerical_diff_3(self) -> None:
    ...
    def function_4(self, x1: float) -> float:
        return 3.0 ** 2.0 + x1 * x1

    def test_numerical_diff_4(self) -> None:
        result1 = self.nwl.numerical_diff(self.function_4, 4.0)
        self.assertEqual(result1, 7.999999999999119)

    def test_numerial_gradient(self) -> None:
